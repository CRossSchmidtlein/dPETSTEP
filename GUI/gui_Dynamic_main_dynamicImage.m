function [FBP4D,OS4D,OSpsf4D,counts,countsNoise,nFWprompts,FWtrues,FWscatters,FWrandoms,wcc] = gui_Dynamic_main_dynamicImage(data,simSet,scaleFactor)
%******************************************************************************************************
% Run a complete dynamic PET simulation.
%
% USAGE  : [FBP4D,OS4D,OSpsf4D,counts,countsNoise,nFWprompts,FWtrues,FWscatters,FWrandoms,wcc] = gui_Dynamic_main_dynamicImage(data,simSet,scaleFactor)
%
...
%
% OUTPUT : FBP4D        Reconstructed dynamic FBP image in (Bq/cc). 
