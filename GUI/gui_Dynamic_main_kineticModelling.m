function [data,FBP4D,OS4D,OSpsf4D,counts,countsNoise,nFWprompts,FWtrues,FWscatters,FWrandoms,wcc] = gui_Dynamic_main_kineticModelling(data,simSet,scaleFactor)
%******************************************************************************************************
% Run a complete dynamic PET simulation.
%
% USAGE  : [data,FBP4D,OS4D,OSpsf4D,counts,countsNoise,nFWprompts,FWtrues,FWscatters,FWrandoms,wcc] = gui_Dynamic_main_kineticModelling(data,simSet,scaleFactor)
%
...
frame            = simSet.frame;           % Time frame vector.
noFrames         = numel(frame)-1;         % Number of time points.
Cif              = simSet.Cif;             % Input function.
