function [p,fitInfo] = fit_FRTM_lsqnonlin(t, C, Cref, w, p0, dt, doPlot, lowerBounds, upperBounds, options)
%%
%*******************************************************************************************************
...
%|                                                                                                     |
%| USAGE  :  p = fit_FRTM_lsqnonlin(t,C,Cref,w,p0,dt,doPlot,lowerBounds,upperBounds,options).          |
%|                                                                                                     |
