function [data,simSet,FBP4D,OS4D,OSpsf4D,counts,countsNoise,nFWprompts,FWtrues,FWscatters,FWrandoms,wcc] = Dynamic_main_kineticModelling(data,frame,Cif,scaleFactor)
%******************************************************************************************************
% Run a complete dynamic PET simulation.
%
% USAGE  : [data,simSet,FBP4D,OS4D,OSpsf4D,counts,countsNoise,nFWprompts,FWtrues,FWscatters,FWrandoms,wcc] = Dynamic_main_kineticModelling(data,frame,Cif,scaleFactor)
%
...
%% Save log file.
logFile = 'Dynamic_main_kineticModelling.log';
...
data(PTscanNum).data                         = scaleFactor*image4D; %Bq/cc
