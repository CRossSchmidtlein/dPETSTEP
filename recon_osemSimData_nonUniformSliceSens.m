function OS = recon_osemSimData_nonUniformSliceSens(nFWPTtotal,RS,CTAC,initPT, ...
...
%
%Usage: 
%   [OS] = recon_osemSimData_nonUniformSliceSens(nFWPTtotal,RS,CTAC,POST,wcc,radBin,tanBin, simSize,zSlice,iterNUM,reconType)
